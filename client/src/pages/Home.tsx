...
export default function Home() {
  ...
  const repoName = useMemo(() => repoUrl.split("/").slice(-1)[0] || "your-repository", [repoUrl]);
  ...
  const inspect = () => {
    ...
    window.setTimeout(() => {
      setAnalyzing(false);
      setAnalyzed(true);
      toast.success("Repository inspected. Deployment recipe is ready.");
    }, 950);
  };
